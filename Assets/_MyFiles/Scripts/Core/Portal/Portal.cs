...
public class Portal : MonoBehaviour {
    ...
    List<PortalTraveler> trackedTravellers;
    ...
    void Awake () {
        ...
        trackedTravellers = new List<PortalTraveler> ();
    ...
    void HandleTravellers () {
        ...
        for (int i = 0; i < trackedTravellers.Count; i++) {
            PortalTraveler traveller = trackedTravellers[i];
    ...
    void UpdateSliceParams (PortalTraveler traveller) {
    ...
    void OnTravellerEnterPortal (PortalTraveler traveller) {
    ...
    void OnTriggerEnter (Collider other) {
        var traveller = other.GetComponent<PortalTraveler> ();
        if (traveller) {
